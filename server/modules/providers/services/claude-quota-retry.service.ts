...
const QUOTA_ERROR = /rate[_ -]?limit|too many requests|\b429\b|insufficient[_ -]?quota|quota.{0,60}(?:exceed|exhaust|insufficient)|(?:usage|spending|session|weekly|five.hour|5.hour) limit|(?:hit|reached|exceeded) your limit|(?:额度|配额).{0,20}(?:不足|耗尽|用完|超|限制)|限流|no available accounts|\b502\b|\b503\b|\b504\b|bad gateway|service unavailable|gateway timeout/i;
